...
(1, 1),  -- PVR shows Avengers
(2, 2),  -- INOX shows Joker
(3, 3),  -- Cinepolis shows 3 Idiots
(1, 4),   -- PVR shows vanvas
(2, 5),  -- INOX shows Dangal
(1,3), -- PVR shows 3 idiots
(2,1), -- INOX shows Avengers
(3,5); -- Cinepolis shows Dangal
